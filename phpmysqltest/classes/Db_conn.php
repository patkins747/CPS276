...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'patkins';//this will be your WCC username
      $dbUsr = 'patkins';//this will be your WCC username
      $dbPass = 'wMEDxXuOxqSe4Vl';//this will be the password found in the video.
